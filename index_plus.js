...
const OPT = { //网站配置
  ...
  "logo":"https://cdn.jsdelivr.net/gh/XSTMagpie/cfblog-plus@master/themes/JustNews/files/logo2.png",//JustNews主题的logo

  "theme_github_path":"https://cdn.jsdelivr.net/gh/XSTMagpie/cfblog-plus@master/themes/",//主题路径
  "themeURL" : "https://raw.githubusercontent.com/XSTMagpie/cfblog-plus/master/themes/JustNews/", // 模板地址,以 "/"" 结尾
...
Disallow: /admin`,//robots.txt设置
  ...
  "editor_page_scripts": `
    ...
    if($('#img').val()=="")$('#img').val('https://cdn.jsdelivr.net/gh/XSTMagpie/pictures@master/public/cfblog-plus.png');
    //默认时间设置为当前时间
